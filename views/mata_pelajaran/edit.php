<?php
    ...
    $mapel = $mapelController->getMapelById($id);
    if (!$mapel) {
    ...
    if (isset($_POST['update'])) {
        ...
        $mapelController->updateMapel($id, $data);
        exit;
    }
?>
        ...
        <div class="content-body">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_mapel" value="<?= htmlspecialchars($mapel['nama_mapel']); ?>" required>
                </div>
                <div class="form-group">
                    <label>Kelas:</label>
                    <input type="text" name="kelas" value="<?= htmlspecialchars($mapel['kelas']); ?>" required>
                </div>
                <div class="form-group">
                    <label>Guru Pengajar:</label>
                    <input type="text" name="guru_pengajar" value="<?= htmlspecialchars($mapel['guru_pengajar']); ?>" required>
                </div>
