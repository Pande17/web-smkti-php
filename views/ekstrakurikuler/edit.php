<?php
    ...
    $ekstrakurikuler = $ekstrakurikulerController->getEkstrakurikulerById($id);
    if (!$ekstrakurikuler) {
    ...
    if (isset($_POST['update'])) {
        ...
        $ekstrakurikulerController->updateEkstrakurikuler($id, $data);
        exit;
    }
?>
        ...
        <div class="content-body">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ekstra" value="<?= htmlspecialchars($ekstrakurikuler['nama_ekstra']); ?>" required>
                </div>
                <div class="form-group">
                    <label>Jadwal:</label>
                    <input type="text" name="jadwal" value="<?= htmlspecialchars($ekstrakurikuler['jadwal']); ?>" required>
                </div>
                <div class="form-group">
                    <label>Guru Pengajar:</label>
                    <input type="text" name="guru_pengajar" value="<?= htmlspecialchars($ekstrakurikuler['guru_pengajar']); ?>" required>
                </div>
